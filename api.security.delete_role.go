...
func newDeleteRoleFunc(t esapi.Transport) DeleteRole {
	return func(o ...func(*DeleteRoleRequest)) (*esapi.Response, error) {
...
// DeleteRole - Removes roles in the native realm.
//
// See full documentation at https://docs-beta.opensearch.org/security-plugin/access-control/api/#roles.
//
type DeleteRole func(o ...func(*DeleteRoleRequest)) (*esapi.Response, error)

// DeleteRoleRequest configures the Security Delete Role API request.
//
...
//
func (r DeleteRoleRequest) Do(ctx context.Context, transport esapi.Transport) (*esapi.Response, error) {
	var (
		method string
...
//
func (f DeleteRole) WithName(v string) func(*DeleteRoleRequest) {
	return func(r *DeleteRoleRequest) {
		r.Name = v
	}
}
