...
func newGetRoleFunc(t esapi.Transport) GetRole {
	return func(o ...func(*GetRoleRequest)) (*esapi.Response, error) {
...
// GetRole - Retrieves roles in the native realm.
//
// See full documentation at https://docs-beta.opensearch.org/security-plugin/access-control/api/#roles.
//
type GetRole func(o ...func(*GetRoleRequest)) (*esapi.Response, error)

// GetRoleRequest configures the Security Get Role API request.
//
...
//
func (r GetRoleRequest) Do(ctx context.Context, transport esapi.Transport) (*esapi.Response, error) {
	var (
		method string
...
//
func (f GetRole) WithName(v string) func(*GetRoleRequest) {
	return func(r *GetRoleRequest) {
		r.Name = v
	}
}
